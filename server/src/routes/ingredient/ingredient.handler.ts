...
import { ingredientType, addIngredientType, deleteIngredientType } from "./ingredient.routes";
...
export const deleteIngredient: AppRouteHandler<deleteIngredientType> = async (c) => {
